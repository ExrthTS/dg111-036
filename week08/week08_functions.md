...
**คำตอบ:** เพราะว่า hp ไม่ได้ถูกอัพเดท แต่ไปอัพเดท safeHP และ hp เป็นเพียงแค่ค่าตัวเลขอ้างอิงเพื่อส่งเข้าไปใน function

### 2.2 `lerp` — Local Scope

**คำถาม:** ทำไม `main()` ถึงมองไม่เห็นตัวแปร `result` ทั้งที่มันถูกประกาศไว้ในไฟล์เดียวกัน?

**คำตอบ:** เป็นเรื่องของ Local Scope ที่ว่าตัวแปรที่สสร้างขึ้นข้างในจะไม่สามารถเห็นจากข้างนอกได้ ซึ่ง result โดนประกาศในข้างในและ return แค่ค่าเท่านั้น ไม่ได้เอาตัวแปรออกมา
...
**คำตอบ:** เป็นเพียงการส่งค่าเข้าไปใช้ใน function ไม่ใช่การเปลี่ยนค่าตัวแปร
...
**คำตอบ: เป็นเพียงการส่งค่าไปประมวลใน function อีกเช่นกัน**
